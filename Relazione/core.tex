...
\footnotetext[2]{Queste funzioni hanno diverse versioni di complessità uguale}
\footnotetext[3]{qui la funzione viene chiamata in una certa posizione dello heap, i. Corrisponde a idx+1 nel codice.}
